...
cinque<-c("ATOH1","DLL1","HES1","APCDD1", "CDKN1A", "CDKN1B") #,"DEFA6","OLFM4","NOTCH1","NOTCH2","HES1","DLL4","APCDD1","WNT6","LGR5","BTC","AREG","EGF","ERBB2","ERBB3","EREG","HBEGF","TGFA","EGFR","ERBB2","SPDEF","CREB3L4")
